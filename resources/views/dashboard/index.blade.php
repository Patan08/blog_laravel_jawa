        ...
        <div class="max-w-7xl mx-auto sm:px-6">
            <div class="bg-white overflow-hidden shadow-xs sm:rounded-lg">
                <div class="p-4  text-gray-900">
                    @if (Session::has('success'))
                        ...
                        <div class="flex justify-center">
                            <div id="toast-success"
                                class="absolute top-30 flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow-sm dark:text-gray-400 dark:bg-gray-800"
                                role="alert">
                                <div
                    ...
                    <h2 class="text-2xl font-semibold m-2">Posts List</h2>
                    <!-- Start block -->
                                                    ...
                                                    <td class="px-4 py-3 flex items-center justify-end">
                                                        ...
                                                        <div id="post-{{ $post->id }}-dropdown"
                                                            ...
                                                            <ul class="py-1 text-sm"
                                                                ...
                                                                <li>
                                                                    <button type="button"
                                                                        data-modal-target="post-{{ $post->id }}-deleteModal"
                                                                        data-modal-toggle="post-{{ $post->id }}-deleteModal"
                                                        ...
                                                        <!-- Delete modal -->
                                                        <div id="post-{{ $post->id }}-deleteModal" tabindex="-1"
                                                            aria-hidden="true"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <button
                                                                            ...
                                                                            cancel</button>
                                                                        <form
                                                                            action={{ route('dashboard.post.destroy') }}
                                                                            method="POST">
                                                                            @method('DELETE')
                                                                            @csrf
